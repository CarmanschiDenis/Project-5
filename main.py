...
def game(current_player):
    ...
    while True:
        ...
        try:
            print("player", current_player, "turn.") #el va incerca sa efectueze(respectiv daca e corect va sari peste except)
            print("Which box? :", end="")
            move = int(input())
...
if __name__ == '__main__':
    print("Player 1: ")
    player1 = input("enter a name ... ")
    print("\n")

    print("Player 2: ")
    player2 = input("enter a name...")
    print("\n")
